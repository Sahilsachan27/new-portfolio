...
export const Timeline = ({
  ...
  return (
    <div
      className="w-full bg-[#F6F7F4] dark:bg-neutral-950 font-sans md:px-10"
      ref={containerRef}>
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-black dark:text-white max-w-4xl">
          Commits of My Career
        </h2>
        <p
          className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-sm">
          A version-controlled journey of how I grew as a full-stack developer and AI enthusiast.
        </p>
      </div>
        ...
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            <div
              ...
              <div
                className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-[#F6F7F4] dark:bg-black flex items-center justify-center">
                <div
